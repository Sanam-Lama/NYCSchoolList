...
import com.example.nycschool.MainApplication
...
//    }
    ...
    override fun onCreateView(
        ...
        (activity as MainApplication).applicationComponent.inject(this)
    }
...
//        val repository = SchoolRepository(schoolService)
        ...
        viewModel = ViewModelProvider(this, schoolViewModelFactory)[SchoolViewModel::class.java]
